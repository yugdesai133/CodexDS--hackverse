...
- **💻 Source Code:** [https://github.com/yugdesai133/CodexDS-Hackverse-VibeCoding](https://github.com/yugdesai133/CodexDS-Hackverse-VibeCoding)
...
Access the Swagger interactive API docs at http://127.0.0.1:8000/docs.3. Launch the Streamlit Frontend Dashboard (New Terminal Tab)Bashstreamlit run app.py
